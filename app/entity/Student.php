...
class Student extends Base
{
    ...
    /**
     * @SWG\Property(title="Тип", enum={"simple", "corporate"})
     * @var string
     */
    public $type;
    ...
    /**
     * @SWG\Property(title="Корпоративный менеджер")
     * @var string
     */
    public $corporate_manager;
